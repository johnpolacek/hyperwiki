...
function App() {
  ...
  function scheduleDesignExplorationAutoReview(
    unitPath: string,
    attempt = 0,
...
function planCreationPrompt(project: ProjectRecord | null, intent = "") {
  ...
  return [
    ...
    "- When a unit creates or changes user-facing screens, add a Screen content & layout section: describe the shared frame once, then one Screen (name, optional route/step/progress) per screen with its purpose, canonical copy as final wording, top-to-bottom layout, states, and the action each control commits. Use Mockup with an ASCII wireframe when a quick visual helps; keep the wireframe as plain text.",
