        ...
        &format!(
            ...
            serde_json::to_string_pretty(&serde_json::json!({
                ...
                "previewCapture": {
                    ...
                    "signInPath": "/sign-in",
                    "readyPath": "/",
                    "authEmailEnv": "HYPERWIKI_PREVIEW_AUTH_EMAIL",
                    "authPasswordEnv": "HYPERWIKI_PREVIEW_AUTH_PASSWORD",
...
<section id="promotion"><h2>Promotion Criteria</h2><ul><li>A working prototype that can generate interesting narration from live location data.</li><li>A strong hands-free voice interaction design.</li></ul></section>
    ...
    fn init_writes_static_package_and_dev_preview_config_for_root_index_html() {
        ...
        assert!(agents.contains("include the wiki changes it produced"));
