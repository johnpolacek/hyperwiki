    ...
    json!({
        "theme": {
            ...
            "presets": {
                ...
                "daybreak": preset("Daybreak", "light", font("figtree"), font("jetBrainsMono"), "#f4f8fb", "#ffffff", "#cddbe7", "#172432", "#607284", "#2563eb", "#fbfdff", "#ffffff", "#d7e3ef", "#182536", "#667589", "#2563eb", "#eaf2fb", "#f8fafc", "#eef4fa", "#e6edf5", "#f1f6fb", "#cad7e4", "#17202c", "#64748b", "#2563eb"),
