...
assert.ok(source.includes("border-b border-[#2c302d] text-xs") && source.includes('className="terminal-scrollbar-thin h-full min-h-0 p-1"'), "Terminal pane headers and xterm padding should match the compact chrome");
